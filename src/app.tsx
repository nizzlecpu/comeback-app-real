...
const SPORTS = [
  {id:"basketball",label:"Basketball",icon:"🏀",color:"#F97316",athlete:"LeBron James",liveUsers:2847,
   img:"https://images.unsplash.com/photo-1546519638-68e109498ffc?w=400&q=80",
   quotes:['"Ice 20 min, elevate, compress. Don\'t rush the timeline."','"Sleep is my best recovery tool. 12 hours a night."','"Ice baths changed my career. 10 min at 55F post-game."','"30g protein within 20 min of stopping. That window is real."','"The hardest day is day 3. Push through it."']},
  {id:"football",label:"Football",icon:"🏈",color:"#16A34A",athlete:"Patrick Mahomes",liveUsers:3124,
  ...
  {id:"soccer",label:"Soccer",icon:"⚽",color:"#0EA5E9",athlete:"Cristiano Ronaldo",liveUsers:4521,
   img:"https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=400&q=80",
   quotes:['"Cold water immersion after every session."','"Recovery is my career investment."','"Sleep 8 hours minimum."','"Nutrition is 50% of recovery."','"Flexibility saved my knees."']},
  {id:"baseball",label:"Baseball",icon:"⚾",color:"#EF4444",athlete:"Shohei Ohtani",liveUsers:1893,
   img:"https://images.unsplash.com/photo-1508344928928-7165b67de128?w=400&q=80",
   quotes:['"Rotator cuff work is never optional."','"Arm care starts before you feel pain."','"I track HRV every morning."','"Cross-training in the pool saved my shoulder."','"Recovery is just another form of training."']},
  {id:"tennis",label:"Tennis",icon:"🎾",color:"#65A30D",athlete:"Serena Williams",liveUsers:1456,
   ...
   quotes:['"Listen to inflammation signals."','"Mental game breaks down first."','"Eccentric strengthening for tendons."','"Cry and then do the work."','"Work with a sports dietitian."']},
  {id:"track",label:"Track & Field",icon:"🏃",color:"#A855F7",athlete:"Usain Bolt",liveUsers:987,
   img:"https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=400&q=80",
   quotes:['"Hip flexor mobility is the unlock."','"The body remembers what you build."','"Speed is neurological as much as muscular."','"God didn\'t give you these legs to sit."','"Water running kept my fitness alive."']},
  {id:"swimming",label:"Swimming",icon:"🏊",color:"#0EA5E9",athlete:"Michael Phelps",liveUsers:743,
  ...
  {id:"volleyball",label:"Volleyball",icon:"🏐",color:"#F59E0B",athlete:"Misty May-Treanor",liveUsers:621,
  ...
  {id:"golf",label:"Golf",icon:"⛳",color:"#16A34A",athlete:"Tiger Woods",liveUsers:1102,
  ...
  {id:"mma",label:"MMA / Combat",icon:"🥊",color:"#EF4444",athlete:"Conor McGregor",liveUsers:2341,
  ...
  {id:"gymnastics",label:"Gymnastics",icon:"🤸",color:"#EC4899",athlete:"Simone Biles",liveUsers:834,
   img:"https://images.unsplash.com/photo-1577474994498-5d7693a5c9d9?w=400&q=80",
   quotes:['"Mental recovery is as real as physical."','"Taking time off was the bravest decision."','"Trust your body\'s timeline."','"Fear is just another skill to master."','"The body will catch up to where the mind went."']},
  {id:"cycling",label:"Cycling",icon:"🚴",color:"#6366F1",athlete:"Chris Froome",liveUsers:567,
  ...
  {id:"hockey",label:"Hockey",icon:"🏒",color:"#334155",athlete:"Sidney Crosby",liveUsers:1678,
   img:"https://images.unsplash.com/photo-1515703407324-5f753afd8be8?w=400&q=80",
   quotes:['"Concussion protocol is sacred."','"Cognitive rest is a skill."','"Sleep became medicine."','"A good team respects your recovery."','"Fear of another concussion is real."']},
  {id:"rugby",label:"Rugby",icon:"🏉",color:"#F59E0B",athlete:"Richie McCaw",liveUsers:892,
...
const INJURIES = [
  ...
  {id:"meniscus",label:"Meniscus Tear",icon:"🦵",weeks:24,phase1:"Weeks 1–4: Crutches, ice, pain mgmt. Straight-leg raises. No flexion past 90°.",phase2:"Weeks 5–12: Quad/hamstring balance, bike wk 6. No twisting.",phase3:"Weeks 13–24: Lateral movement, cutting drills, physician clearance."},
  ...
  {id:"hamstring",label:"Hamstring Strain",icon:"🦵",weeks:12,phase1:"Weeks 1–2: Active rest, ice. NO passive static stretching (re-tear risk).",phase2:"Weeks 3–6: Nordic eccentric program (Askling protocol), bike wk 3.",phase3:"Weeks 7–12: Graduated sprint 60 to 100% with weekly H-test."},
  {id:"rotator",label:"Rotator Cuff",icon:"💪",weeks:20,phase1:"Weeks 1–6: Sling, pendulums, zero active elevation. Cryo 20 min 5x/day.",phase2:"Weeks 7–14: Bands, scapular stability. ER/IR at 0 degrees.",phase3:"Weeks 15–20: Progressive overhead, throwing program. ASES score 85+."},
  ...
  {id:"concussion",label:"Concussion",icon:"🧠",weeks:6,phase1:"Days 1–5: Full cognitive and physical rest. No screens. Symptom check every 2hrs.",phase2:"Weeks 2–4: Sub-symptom aerobic only. Buffalo Treadmill Test.",phase3:"Weeks 5–6: Non-contact sport drills. SCAT5 plus physician sign-off."},
  {id:"back",label:"Lower Back Strain",icon:"🔙",weeks:8,phase1:"Weeks 1–2: McKenzie extension. Cat-cow, bird-dog, decompression walks.",phase2:"Weeks 3–5: McGill Big 3, dead bug, hip hinge patterning.",phase3:"Weeks 6–8: Deadlift bodyweight, RDL, core loading."},
  {id:"shin",label:"Shin Splints",icon:"🦵",weeks:6,phase1:"Days 1–10: Rest, ice massage 3x/day, calf stretching.",phase2:"Weeks 2–4: Swim, bike, calf strengthening. Arch check.",phase3:"Weeks 5–6: Walk-run intervals, gait analysis, 10% rule."},
  {id:"shoulder",label:"Shoulder Dislocation",icon:"💪",weeks:12,phase1:"Weeks 1–4: Sling. No elevation above 90 degrees. Cryo plus NSAIDs.",phase2:"Weeks 5–8: Band ER/IR, scapular stabilization, isometrics.",phase3:"Weeks 9–12: Overhead cleared. Apprehension test negative before contact."},
  {id:"knee",label:"Knee Pain",icon:"🦵",weeks:10,phase1:"Weeks 1–2: RICE, quad sets, avoid stairs. Inflammation control.",phase2:"Weeks 3–6: Bike, step-ups, mini-squats 0 to 45 degrees.",phase3:"Weeks 7–10: Progressive load, sport-specific movement."},
...
const SUPPLEMENTS = [
  {id:"d3",label:"Vitamin D3",dose:"2,000 IU",time:"7:00 AM",with:"breakfast",note:"Bone and immune support. Take with a fatty meal for best absorption.",color:"#F59E0B",bg:"#FFF7ED"},
  {id:"omega3",label:"Omega-3",dose:"1g EPA+DHA",time:"8:00 AM",with:"breakfast",note:"Reduces inflammation 25 to 40%. Take with food to avoid fish aftertaste.",color:"#0EA5E9",bg:"#E0F2FE"},
  {id:"vitc",label:"Vitamin C",dose:"500mg",time:"10:00 AM",with:"snack",note:"Collagen synthesis for tendons. Pairs best with collagen peptides.",color:"#F97316",bg:"#FFF0E6"},
  {id:"collagen",label:"Collagen Peptides",dose:"10g",time:"10:00 AM",with:"pre-rehab",note:"Take 30 min before rehab session plus Vitamin C for max tendon benefit.",color:"#EC4899",bg:"#FDF2F8"},
  {id:"zinc",label:"Zinc",dose:"15mg",time:"1:00 PM",with:"lunch",note:"Tissue repair and immune support. Take with food as it causes nausea on empty stomach.",color:"#10B981",bg:"#D1FAE5"},
  {id:"mag",label:"Magnesium",dose:"400mg",time:"9:00 PM",with:"dinner",note:"Take at night as it aids sleep quality and muscle relaxation.",color:"#A855F7",bg:"#F5F3FF"},
];
...
const DIET_GUIDE = [
  ...
  {category:"⚡ Energy Pre-Workout",foods:"Sweet potato, oats, banana, dates",avoid:"Simple sugars, alcohol which delays recovery 48hrs+"},
  {category:"💧 Hydration",foods:"3 to 4L water daily, electrolytes if sweating, coconut water",avoid:"Sports drinks with HFCS, energy drinks"},
];
...
const DAY_PROTOCOLS: Task[][] = [
  [
    {time:"6:30 AM",task:"Hydrate 500ml water with a pinch of sea salt for electrolytes before anything else",icon:"💧",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"7:00 AM",task:"5-min deep breathing (4-7-8 method) plus gentle mobility to loosen the injured area",icon:"🌅",iconColor:"#F59E0B",iconBg:"#FFF7ED"},
    {time:"8:00 AM",task:"Breakfast plus morning supplements: D3 2,000 IU and Omega-3 1g with food",icon:"💊",iconColor:"#6366F1",iconBg:"#EDE9FE"},
    {time:"10:00 AM",task:"Rehab session A: injury-specific exercises 3 sets. Focus on controlled movement, zero pain.",icon:"🏋️",iconColor:"#F97316",iconBg:"#FFF0E6"},
    {time:"10:30 AM",task:"Vitamin C 500mg plus Collagen 10g immediately after rehab — collagen synthesis window",icon:"💊",iconColor:"#EC4899",iconBg:"#FDF2F8"},
    {time:"12:00 PM",task:"Lunch: 40g protein (salmon or chicken) plus complex carbs plus leafy greens. Zinc 15mg with meal.",icon:"🥗",iconColor:"#16A34A",iconBg:"#F0FDF4"},
    {time:"2:00 PM",task:"Ice and compression 20 min on injury site plus elevation above heart to reduce inflammation",icon:"🧊",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"4:00 PM",task:"Low-impact cardio: 20 min stationary bike or pool walk to maintain base fitness",icon:"🚴",iconColor:"#A855F7",iconBg:"#F5F3FF"},
    {time:"7:00 PM",task:"Dinner: 40g protein plus anti-inflammatory fats (olive oil, avocado). Magnesium 400mg.",icon:"🍽️",iconColor:"#10B981",iconBg:"#D1FAE5"},
    {time:"9:00 PM",task:"10-min foam roll avoiding injured area, stretching, sleep target 9 hours",icon:"😴",iconColor:"#334155",iconBg:"#F1F5F9"},
  ],
  [
    {time:"6:30 AM",task:"Morning hydration 500ml. Rate injury pain 1 to 10 before getting out of bed.",icon:"💧",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"7:00 AM",task:"10-min dynamic warm-up: leg swings, arm circles, hip circles — activate without loading",icon:"🌅",iconColor:"#F59E0B",iconBg:"#FFF7ED"},
    {time:"8:00 AM",task:"Breakfast plus D3 2,000 IU and Omega-3 1g. Take with fat-containing meal for absorption.",icon:"💊",iconColor:"#6366F1",iconBg:"#EDE9FE"},
    {time:"10:00 AM",task:"Rehab session B: add one rep or 5% more resistance than last session. Progressive overload.",icon:"🏋️",iconColor:"#F97316",iconBg:"#FFF0E6"},
    {time:"10:30 AM",task:"Collagen 10g plus Vitamin C 500mg post-session. 30-min window for tendon synthesis.",icon:"💊",iconColor:"#EC4899",iconBg:"#FDF2F8"},
    {time:"12:00 PM",task:"Lunch: 40g protein plus sweet potato plus spinach salad. Zinc 15mg with meal.",icon:"🥗",iconColor:"#16A34A",iconBg:"#F0FDF4"},
    {time:"2:30 PM",task:"Ice massage using frozen cup on injury 10 min. Reduces localized inflammation better than ice pack.",icon:"🧊",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"4:00 PM",task:"Upper body strength non-injured: 3x15 rows, press, curls to maintain muscle mass",icon:"💪",iconColor:"#A855F7",iconBg:"#F5F3FF"},
    {time:"7:00 PM",task:"Dinner: salmon or sardines plus quinoa plus broccoli. Magnesium 400mg before bed.",icon:"🍽️",iconColor:"#10B981",iconBg:"#D1FAE5"},
    {time:"9:30 PM",task:"Visualization: 5 min eyes closed, picture yourself fully recovered competing. Then sleep.",icon:"😴",iconColor:"#334155",iconBg:"#F1F5F9"},
  ],
  [
    {time:"6:30 AM",task:"Hydrate 500ml plus tart cherry juice 8oz which is a natural anti-inflammatory reducing DOMS by 22%",icon:"💧",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"7:00 AM",task:"Contrast shower: 2 min warm then 30 sec cold, repeat 4 cycles. Boosts circulation and recovery.",icon:"🌅",iconColor:"#F59E0B",iconBg:"#FFF7ED"},
    {time:"8:00 AM",task:"High-protein breakfast: 3 eggs plus Greek yogurt. D3 plus Omega-3 with meal.",icon:"💊",iconColor:"#6366F1",iconBg:"#EDE9FE"},
    {time:"10:00 AM",task:"Active recovery day: 50% intensity rehab. Focus on range of motion not load today.",icon:"🏋️",iconColor:"#F97316",iconBg:"#FFF0E6"},
    {time:"10:30 AM",task:"Collagen 10g plus Vitamin C 500mg post-session",icon:"💊",iconColor:"#EC4899",iconBg:"#FDF2F8"},
    {time:"12:00 PM",task:"Lunch: 40g protein. Anti-inflammatory focus: turmeric in meal, olive oil dressing.",icon:"🥗",iconColor:"#16A34A",iconBg:"#F0FDF4"},
    {time:"2:00 PM",task:"Pool session 20 min OR ice bath 10 min at 55F if available. Elite recovery method.",icon:"🏊",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"4:30 PM",task:"Core stability: dead bug 3x10, pallof press 3x12, bird-dog 3x10 each side",icon:"💪",iconColor:"#A855F7",iconBg:"#F5F3FF"},
    {time:"7:00 PM",task:"Dinner: chicken or tofu plus lentils plus vegetables. Magnesium 400mg.",icon:"🍽️",iconColor:"#10B981",iconBg:"#D1FAE5"},
    {time:"9:00 PM",task:"Gratitude journal: write 3 things you CAN do today. Sleep 9 hours.",icon:"😴",iconColor:"#334155",iconBg:"#F1F5F9"},
  ],
  [
    {time:"6:30 AM",task:"500ml water. Photograph the injury weekly to track swelling reduction over time.",icon:"💧",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"7:00 AM",task:"10-min yoga flow for recovery: hip flexors, hamstrings, shoulders, spine",icon:"🌅",iconColor:"#F59E0B",iconBg:"#FFF7ED"},
    {time:"8:00 AM",task:"Breakfast: oatmeal plus protein powder plus berries. D3 plus Omega-3 with meal.",icon:"💊",iconColor:"#6366F1",iconBg:"#EDE9FE"},
    {time:"10:00 AM",task:"Rehab session C: neuromuscular focus. Balance drills and proprioception training today.",icon:"🏋️",iconColor:"#F97316",iconBg:"#FFF0E6"},
    {time:"10:30 AM",task:"Collagen plus Vitamin C immediately post-session",icon:"💊",iconColor:"#EC4899",iconBg:"#FDF2F8"},
    {time:"12:00 PM",task:"Lunch: 35 to 40g protein. Zinc 15mg. Add ginger to meal for gingerol anti-inflammatory compound.",icon:"🥗",iconColor:"#16A34A",iconBg:"#F0FDF4"},
    {time:"3:00 PM",task:"Compression sleeve 30 min OR legs-up-wall 20 min to reduce edema",icon:"🧊",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"4:30 PM",task:"Mental skills: sport psychology content OR journaling recovery goals and progress",icon:"🧠",iconColor:"#A855F7",iconBg:"#F5F3FF"},
    {time:"7:00 PM",task:"Dinner: fatty fish or lean beef plus sweet potato plus greens. Magnesium 400mg.",icon:"🍽️",iconColor:"#10B981",iconBg:"#D1FAE5"},
    {time:"9:00 PM",task:"No screens 1hr before sleep. Read or meditate. 9-hr sleep target.",icon:"😴",iconColor:"#334155",iconBg:"#F1F5F9"},
  ],
  [
    {time:"6:30 AM",task:"Hydrate 500ml. Even 5-min gentle walking or crutch-assisted movement boosts morning circulation.",icon:"💧",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"7:00 AM",task:"Body check: rate pain, stiffness, energy 1 to 10. Adjust today's intensity if pain is above 5.",icon:"🌅",iconColor:"#F59E0B",iconBg:"#FFF7ED"},
    {time:"8:00 AM",task:"Breakfast plus D3 plus Omega-3. High-calorie day if energy is low — do not under-eat during recovery.",icon:"💊",iconColor:"#6366F1",iconBg:"#EDE9FE"},
    {time:"10:00 AM",task:"Rehab session D: eccentric focus. Slow 3-second lowering phase. Eccentric loading heals tendons.",icon:"🏋️",iconColor:"#F97316",iconBg:"#FFF0E6"},
    {time:"10:30 AM",task:"Collagen 10g plus Vitamin C 500mg. Protein shake within 20 min post-session.",icon:"💊",iconColor:"#EC4899",iconBg:"#FDF2F8"},
    {time:"12:30 PM",task:"Lunch: eggs plus whole grains plus leafy greens. Zinc 15mg with meal.",icon:"🥗",iconColor:"#16A34A",iconBg:"#F0FDF4"},
    {time:"2:30 PM",task:"20-min stationary bike easy pace. Pedaling lubricates joints without impact stress.",icon:"🚴",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"4:00 PM",task:"Stretch and foam roll 10 min full body avoiding injured site: quads, glutes, calves",icon:"💪",iconColor:"#A855F7",iconBg:"#F5F3FF"},
    {time:"7:00 PM",task:"Dinner: Greek yogurt plus nuts plus fruit OR full protein meal. Magnesium 400mg.",icon:"🍽️",iconColor:"#10B981",iconBg:"#D1FAE5"},
    {time:"9:00 PM",task:"Sleep hygiene: cool room 65 to 68F, dark, no phone. 9-hr recovery window.",icon:"😴",iconColor:"#334155",iconBg:"#F1F5F9"},
  ],
  [
    {time:"6:30 AM",task:"500ml water plus electrolyte tablet if yesterday was a heavy sweat session",icon:"💧",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"7:00 AM",task:"10-min mindfulness meditation. Reduces cortisol which is proven to slow tissue healing.",icon:"🌅",iconColor:"#F59E0B",iconBg:"#FFF7ED"},
    {time:"8:00 AM",task:"High-protein start: protein shake plus eggs. D3 plus Omega-3 with meal.",icon:"💊",iconColor:"#6366F1",iconBg:"#EDE9FE"},
    {time:"10:00 AM",task:"Heavy rehab day: push to 80% effort if pain allows. Log reps and resistance used.",icon:"🏋️",iconColor:"#F97316",iconBg:"#FFF0E6"},
    {time:"10:30 AM",task:"Collagen plus Vitamin C immediately. Protein shake within 20 min post-session.",icon:"💊",iconColor:"#EC4899",iconBg:"#FDF2F8"},
    {time:"12:00 PM",task:"High-protein lunch: 50g protein today. Salmon plus rice plus avocado. Zinc 15mg.",icon:"🥗",iconColor:"#16A34A",iconBg:"#F0FDF4"},
    {time:"2:00 PM",task:"Ice bath or contrast therapy post heavy session. 10 min at 55F.",icon:"🧊",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"5:00 PM",task:"Review progress: compare this week's exercises to last week. Are you stronger?",icon:"📊",iconColor:"#A855F7",iconBg:"#F5F3FF"},
    {time:"7:00 PM",task:"Dinner: lean protein plus complex carbs plus vegetables. Magnesium 400mg.",icon:"🍽️",iconColor:"#10B981",iconBg:"#D1FAE5"},
    {time:"9:00 PM",task:"Call or text someone on your support team. Recovery is social. Then sleep.",icon:"😴",iconColor:"#334155",iconBg:"#F1F5F9"},
  ],
  [
    {time:"6:30 AM",task:"Active recovery day: 500ml water plus light 10-min walk outside if possible",icon:"💧",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"7:00 AM",task:"Gentle stretch 20 min full body. Hold each stretch 30 to 45 seconds. Breathe deeply.",icon:"🌅",iconColor:"#F59E0B",iconBg:"#FFF7ED"},
    {time:"8:00 AM",task:"Breakfast plus D3 plus Omega-3. Rest day: still hit protein target with slight calorie reduction.",icon:"💊",iconColor:"#6366F1",iconBg:"#EDE9FE"},
    {time:"10:00 AM",task:"Weekly check-in: measure range of motion, note pain levels, log everything in journal",icon:"📋",iconColor:"#F97316",iconBg:"#FFF0E6"},
    {time:"10:30 AM",task:"Collagen plus Vitamin C even on rest days as tendon building is a continuous process",icon:"💊",iconColor:"#EC4899",iconBg:"#FDF2F8"},
    {time:"12:00 PM",task:"Balanced lunch: protein plus fat plus fiber. Zinc 15mg.",icon:"🥗",iconColor:"#16A34A",iconBg:"#F0FDF4"},
    {time:"2:00 PM",task:"Mental recovery: watch film of your sport, stay connected to the game mentally",icon:"🎬",iconColor:"#0EA5E9",iconBg:"#E0F2FE"},
    {time:"4:00 PM",task:"Light pool session 15 min OR gentle yoga. Active recovery not passive rest.",icon:"🏊",iconColor:"#A855F7",iconBg:"#F5F3FF"},
    {time:"7:00 PM",task:"Dinner: meal prep for the week ahead. Magnesium 400mg. Prioritize sleep tonight.",icon:"🍽️",iconColor:"#10B981",iconBg:"#D1FAE5"},
    {time:"9:00 PM",task:"Plan next week rehab goals. Write them down. Sleep 9 plus hours — biggest recovery day.",icon:"😴",iconColor:"#334155",iconBg:"#F1F5F9"},
  ],
];
...
const MILESTONES = [
  ...
  {day:14,badge:"💪",title:"Two Weeks",reward:"Warrior Badge plus nutrition guide.",verse:"Press on toward the goal. Philippians 3:14"},
...
const AVATAR_QUOTES: Record<string,string[]> = {
  streak:["You showed up again. Your body is healing faster than you think.","Day after day. That consistency separates good recoveries from great ones.","Your streak tells me everything — you are a competitor even in rehab.","Keep this streak going. Your tissue is literally rebuilding right now.","The ones who show up daily always come back stronger."],
  goal:["Goal complete! Recovery science says consistent completion equals faster healing.","All tasks done today. This is elite-level discipline.","Perfect day. Protein timing, ice protocol, everything. You are doing this right.","Full completion! Patients who hit daily protocols recover 30% faster.","That is how champions train. Every. Single. Task."],
  miss:["Missed tasks today. That is okay — let us fix it tomorrow.","Recovery is not linear. But missing tasks slows the timeline. Back at it tomorrow.","I need you to show up tomorrow. Your injury is counting on your consistency.","One miss does not define your recovery. But patterns do. Back at it."],
  morning:["Good morning athlete. Today is another rep toward your comeback.","Rise up. Your comeback starts with today's protocol.","New day. New chance to heal. What we do today matters for week 6.","Morning! Remember why you started. That reason is bigger than today's discomfort."],
};

function seedPosts(sportId:string): Post[] {
  const seeds: Record<string,Post[]> = {
    basketball:[
      {id:"b1",author:"Marcus T.",msg:"Day 47 post-ACL. Hit 90 degrees ROM today. Nordic curls protocol is legit.",likes:24,likedByMe:false,replies:[{author:"Darius K.",msg:"Keep pushing! Day 82 here — you will be jumping again soon."},{author:"Tina M.",msg:"How long until you could walk without a limp?"}]},
    ...
    football:[
      {id:"f1",author:"Jake M.",msg:"Cleared for contact today. 82 days from torn Achilles. Trust the protocol.",likes:67,likedByMe:false,replies:[{author:"Kyle R.",msg:"How was your mental game during recovery?"},{author:"Jake M.",msg:"Honestly the mental was harder than physical. Week 3 was brutal."}]},
    ],
    soccer:[
      {id:"s1",author:"Priya R.",msg:"Week 3 hamstring. Pool running is saving my cardio base.",likes:18,likedByMe:false,replies:[{author:"Ana S.",msg:"Same! Pool running for 3 weeks. Worth every boring lap."}]},
  ...
  return seeds[sportId] || [{id:"g1",author:"Recovery Community",msg:`Welcome to the ${sportId} recovery squad! Introduce yourself below.`,likes:0,likedByMe:false,replies:[]}];
}
...
function Card({children,style={}}:{children:ReactNode,style?:React.CSSProperties}){
  return <div style={{background:"white",borderRadius:16,padding:"14px 16px",boxShadow:"0 2px 8px rgba(15,23,42,0.06)",border:"1px solid #E2E8F0",...style}}>{children}</div>;
}
...
function PrimaryBtn({children,onClick,style={}}:{children:ReactNode,onClick?:()=>void,style?:React.CSSProperties}){
  return <button onClick={onClick} style={{width:"100%",padding:"15px",borderRadius:14,background:"#6366F1",color:"white",fontWeight:800,fontSize:16,border:"none",cursor:"pointer",...style}}>{children}</button>;
}
function GhostBtn({children,onClick}:{children:ReactNode,onClick?:()=>void}){
  return <button onClick={onClick} style={{width:"100%",padding:"13px",borderRadius:14,background:"transparent",color:"#334155",fontWeight:700,fontSize:14,border:"1.5px solid #E2E8F0",cursor:"pointer"}}>{children}</button>;
}
function Logo({size=28}:{size?:number}){
  return (
    <div style={{display:"flex",alignItems:"center",gap:8}}>
      <div style={{width:size+8,height:size+8,borderRadius:(size+8)/2,background:"#0F172A",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
        <svg width={size*0.65} height={size*0.65} viewBox="0 0 24 24" fill="none">
          <rect x="2" y="9" width="4" height="6" rx="1.5" fill="#E8FF47"/>
          <rect x="18" y="9" width="4" height="6" rx="1.5" fill="#E8FF47"/>
      ...
      <div>
        <div style={{fontWeight:900,fontSize:size*0.75,color:"#0F172A",lineHeight:1,letterSpacing:"-0.5px"}}>Comeback</div>
        <div style={{fontWeight:600,fontSize:size*0.38,color:"#64748B",lineHeight:1,letterSpacing:"1px",textTransform:"uppercase",marginTop:1}}>Sports Recovery</div>
      </div>
    </div>
  );
}
function ProgressBar({pct,color="#6366F1"}:{pct:number,color?:string}){
  return <div style={{height:6,background:"#E2E8F0",borderRadius:3,overflow:"hidden"}}><div style={{height:"100%",width:`${Math.min(pct,100)}%`,background:color,borderRadius:3,transition:"width 0.4s"}}/></div>;
}
function StepBar({total,current}:{total:number,current:number}){
  return <div style={{display:"flex",gap:4,marginBottom:20}}>{Array.from({length:total}).map((_,i)=><div key={i} style={{flex:1,height:4,borderRadius:2,background:i<current?"#6366F1":"#E2E8F0"}}/>)}</div>;
}

function StreakFire({streak,alive}:{streak:number,alive:boolean}){
  const sz = alive ? Math.min(20+streak*0.4,36) : 18;
  const c = alive
  ...
  return (
    <div style={{display:"flex",alignItems:"center",gap:4}}>
      <svg width={sz} height={sz} viewBox="0 0 24 24" fill="none">
        <path d="M12 2C12 2 7 8 7 13C7 15.8 9.2 18 12 18C14.8 18 17 15.8 17 13C17 8 12 2 12 2Z" fill={`url(#fg${streak}a)`}/>
        <path d="M12 10C12 10 9 13 9 15C9 16.7 10.3 18 12 18C13.7 18 15 16.7 15 15C15 13 12 10 12 10Z" fill={c[2]} opacity="0.8"/>
        <defs>
          <linearGradient id={`fg${streak}a`} x1="12" y1="2" x2="12" y2="18" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor={c[0]}/><stop offset="50%" stopColor={c[1]}/><stop offset="100%" stopColor={c[2]}/>
          </linearGradient>
        </defs>
      </svg>
      <span style={{fontWeight:900,fontSize:sz*0.7,color:alive?c[1]:"#94A3B8"}}>{streak}</span>
    </div>
  );
}
...
function AvatarDisplay({avatar,size=80,mood="happy"}:{avatar:Avatar,size?:number,mood?:"happy"|"sad"|"neutral"|"excited"}){
  ...
  const mouthPath=mood==="happy"?`M${s*0.38} ${s*0.56} Q${s*0.5} ${s*0.64} ${s*0.62} ${s*0.56}`:mood==="sad"?`M${s*0.38} ${s*0.62} Q${s*0.5} ${s*0.54} ${s*0.62} ${s*0.62}`:mood==="excited"?`M${s*0.35} ${s*0.54} Q${s*0.5} ${s*0.68} ${s*0.65} ${s*0.54}`:`M${s*0.4} ${s*0.58} L${s*0.6} ${s*0.58}`;
  const hpaths: Record<string,string> = {
    ...
    "Bun":`M${s*.3} ${s*.28} Q${s*.5} ${s*.1} ${s*.7} ${s*.28}`,
  ...
  const isStroke=["Braids","Ponytail"].includes(avatar.hairStyle);
  const hp=hpaths[avatar.hairStyle]||hpaths["Short"];
  const braidsPath=`M${s*.28} ${s*.28} Q${s*.5} ${s*.08} ${s*.72} ${s*.28} M${s*.3} ${s*.35} L${s*.26} ${s*.75} M${s*.7} ${s*.35} L${s*.74} ${s*.75}`;
  const ponytailPath=`M${s*.28} ${s*.28} Q${s*.5} ${s*.08} ${s*.72} ${s*.28} L${s*.5} ${s*.15} L${s*.5} ${s*.08}`;
  return (
    <svg width={s} height={s} viewBox={`0 0 ${s} ${s}`}>
      <ellipse cx={s*0.5} cy={s*0.82} rx={s*0.28} ry={s*0.2} fill={avatar.skinTone} opacity="0.9"/>
      <ellipse cx={s*0.5} cy={s*0.88} rx={s*0.26} ry={s*0.15} fill="#6366F1" opacity="0.85"/>
      <ellipse cx={s*0.5} cy={s*0.42} rx={s*0.22} ry={s*0.24} fill={avatar.skinTone}/>
      {isStroke
        ? <path d={avatar.hairStyle==="Braids"?braidsPath:ponytailPath} stroke={avatar.hairColor} strokeWidth={s*0.04} fill="none" strokeLinecap="round"/>
        : <path d={hp} fill={avatar.hairColor} opacity="0.95"/>
      }
      ...
      {mood==="excited"&&<><circle cx={s*0.75} cy={s*0.2} r={s*0.025} fill="#E8FF47"/><circle cx={s*0.8} cy={s*0.28} r={s*0.015} fill="#E8FF47"/></>}
      {mood==="sad"&&<ellipse cx={s*0.42} cy={s*0.44} rx={s*0.018} ry={s*0.03} fill="#0EA5E9" opacity="0.7"/>}
...
function AvatarBuilder({onSave}:{onSave:(a:Avatar)=>void}){
  ...
  return (
    <div style={{minHeight:"100%",background:"#EBF5FD",display:"flex",flexDirection:"column"}}>
      <div style={{padding:"20px",position:"sticky",top:0,background:"#EBF5FD",zIndex:10}}>
        <Logo size={24}/>
        <h2 style={{fontWeight:900,fontSize:22,color:"#0F172A",marginTop:12,marginBottom:4}}>Build Your Avatar</h2>
        <p style={{fontSize:13,color:"#64748B"}}>Your personal AI trainer coach. Elite plan exclusive.</p>
      </div>
      <div style={{flex:1,overflowY:"auto",padding:"0 20px 32px"}}>
        <div style={{display:"flex",justifyContent:"center",marginBottom:20}}>
          <div style={{background:"white",borderRadius:24,padding:20,boxShadow:"0 8px 24px rgba(15,23,42,0.12)",border:"2px solid #6366F130",display:"inline-flex",flexDirection:"column",alignItems:"center",gap:8}}>
            <AvatarDisplay avatar={av} size={120} mood="happy"/>
            <span style={{fontSize:12,fontWeight:700,color:"#6366F1"}}>Your Trainer</span>
          </div>
        </div>
        <div style={{marginBottom:16}}>
          <div style={{fontWeight:800,fontSize:13,color:"#0F172A",marginBottom:8}}>Gender</div>
          <div style={{display:"flex",gap:8}}>
            {GENDERS.map(g=>(
              <button key={g} onClick={()=>setAv(a=>({...a,gender:g.toLowerCase() as Avatar["gender"]}))}
                style={{flex:1,padding:"10px",borderRadius:12,border:`2px solid ${av.gender===g.toLowerCase()?"#6366F1":"#E2E8F0"}`,background:av.gender===g.toLowerCase()?"#EDE9FE":"white",fontWeight:700,fontSize:12,color:av.gender===g.toLowerCase()?"#6366F1":"#334155",cursor:"pointer"}}>
                {g}
              </button>
            ))}
          </div>
        ...
        <div style={{marginBottom:16}}>
          <div style={{fontWeight:800,fontSize:13,color:"#0F172A",marginBottom:8}}>Skin Tone</div>
          <div style={{display:"flex",gap:8}}>
            {SKIN_TONES.map(s=>(
              <button key={s} onClick={()=>setAv(a=>({...a,skinTone:s}))}
                style={{width:40,height:40,borderRadius:20,background:s,border:`3px solid ${av.skinTone===s?"#6366F1":"transparent"}`,cursor:"pointer"}}/>
            ))}
          </div>
        </div>
        <div style={{marginBottom:16}}>
          <div style={{fontWeight:800,fontSize:13,color:"#0F172A",marginBottom:8}}>Hair Color</div>
          <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
            {HAIR_COLORS.map(c=>(
              <button key={c} onClick={()=>setAv(a=>({...a,hairColor:c}))}
                style={{width:34,height:34,borderRadius:17,background:c,border:`3px solid ${av.hairColor===c?"#6366F1":"transparent"}`,cursor:"pointer",boxShadow:c==="#FFFFFF"?"inset 0 0 0 1px #ccc":"none"}}/>
            ))}
          </div>
        </div>
        <div style={{marginBottom:16}}>
          <div style={{fontWeight:800,fontSize:13,color:"#0F172A",marginBottom:8}}>Hair Style</div>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
            {HAIR_STYLES.map(s=>(
              <button key={s} onClick={()=>setAv(a=>({...a,hairStyle:s}))}
                style={{padding:"10px",borderRadius:12,border:`2px solid ${av.hairStyle===s?"#6366F1":"#E2E8F0"}`,background:av.hairStyle===s?"#EDE9FE":"white",fontWeight:700,fontSize:12,color:av.hairStyle===s?"#6366F1":"#334155",cursor:"pointer"}}>
                {s}
              </button>
            ))}
          </div>
        ...
        <div style={{marginBottom:24}}>
          <div style={{fontWeight:800,fontSize:13,color:"#0F172A",marginBottom:8}}>Body Type</div>
          <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
            {BODY_TYPES.map(b=>(
              <button key={b} onClick={()=>setAv(a=>({...a,bodyType:b}))}
                style={{padding:"8px 14px",borderRadius:20,border:`2px solid ${av.bodyType===b?"#6366F1":"#E2E8F0"}`,background:av.bodyType===b?"#EDE9FE":"white",fontWeight:700,fontSize:12,color:av.bodyType===b?"#6366F1":"#334155",cursor:"pointer"}}>
                {b}
              </button>
            ))}
          </div>
...
function BodyProfileForm({onSave}:{onSave:(p:BodyProfile)=>void}){
  ...
  return (
    <div style={{padding:"24px",background:"white",borderRadius:20,border:"1px solid #E2E8F0",marginBottom:16}}>
      <h3 style={{fontWeight:900,fontSize:16,color:"#0F172A",marginBottom:4}}>Your Body Profile</h3>
      <p style={{fontSize:12,color:"#64748B",marginBottom:16}}>We will calculate your exact daily macro targets for recovery.</p>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:10}}>
        <div>
          <label style={{fontSize:11,fontWeight:700,color:"#64748B",display:"block",marginBottom:4}}>HEIGHT (cm)</label>
          <input type="number" placeholder="175" value={form.height} onChange={e=>setForm(f=>({...f,height:e.target.value}))}
            style={{width:"100%",padding:"10px",borderRadius:10,border:"1.5px solid #E2E8F0",fontSize:14,fontFamily:"inherit",boxSizing:"border-box"}}/>
        </div>
        <div>
          <label style={{fontSize:11,fontWeight:700,color:"#64748B",display:"block",marginBottom:4}}>WEIGHT (kg)</label>
          <input type="number" placeholder="75" value={form.weight} onChange={e=>setForm(f=>({...f,weight:e.target.value}))}
            style={{width:"100%",padding:"10px",borderRadius:10,border:"1.5px solid #E2E8F0",fontSize:14,fontFamily:"inherit",boxSizing:"border-box"}}/>
        </div>
      </div>
      <div style={{marginBottom:10}}>
        <label style={{fontSize:11,fontWeight:700,color:"#64748B",display:"block",marginBottom:4}}>BIOLOGICAL SEX (for BMR calculation)</label>
        <div style={{display:"flex",gap:8}}>
          {["male","female"].map(g=>(
            <button key={g} onClick={()=>setForm(f=>({...f,gender:g}))}
              style={{flex:1,padding:"8px",borderRadius:10,border:`2px solid ${form.gender===g?"#6366F1":"#E2E8F0"}`,background:form.gender===g?"#EDE9FE":"white",fontWeight:700,fontSize:12,color:form.gender===g?"#6366F1":"#334155",cursor:"pointer",textTransform:"capitalize"}}>
              {g}
            </button>
          ))}
        </div>
      ...
      <button onClick={()=>canSave?onSave(form):null}
        style={{width:"100%",padding:"12px",borderRadius:12,background:canSave?"#10B981":"#E2E8F0",color:canSave?"white":"#64748B",fontWeight:700,fontSize:13,border:"none",cursor:canSave?"pointer":"not-allowed",marginTop:8}}>
        Calculate My Macros
      </button>
    </div>
  );
...
function Welcome({onNext}:{onNext:()=>void}){
  return (
    <div style={{minHeight:"100%",display:"flex",flexDirection:"column",padding:"48px 24px 32px",background:"linear-gradient(160deg,#EDE9FE 0%,#EBF5FD 60%)"}}>
      <div style={{flex:1,display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",textAlign:"center"}}>
        <Logo size={36}/>
        <div style={{marginTop:32,marginBottom:20}}>
          <h1 style={{fontWeight:900,fontSize:34,color:"#0F172A",lineHeight:1.1,letterSpacing:"-1px",marginBottom:12}}>
            Your comeback<br/>starts <span style={{color:"#6366F1"}}>today.</span>
          </h1>
          <p style={{fontSize:15,color:"#64748B",lineHeight:1.6,maxWidth:300,margin:"0 auto"}}>Science-backed recovery protocols. Personalised nutrition. Real day tracking.</p>
        </div>
        <div style={{display:"flex",flexWrap:"wrap",gap:8,justifyContent:"center",marginBottom:28}}>
          {["🏆 Pro protocols","📿 Daily faith","🧪 Evidence-based","📅 Real tracking","🤖 AI Avatar coach"].map((f,i)=>(
            <div key={i} style={{fontSize:11,fontWeight:700,color:"#6D28D9",background:"white",borderRadius:12,padding:"6px 12px",boxShadow:"0 2px 6px rgba(15,23,42,0.08)"}}>{f}</div>
          ))}
        </div>
      </div>
      <PrimaryBtn onClick={onNext}>Build My Recovery Plan</PrimaryBtn>
      <p style={{textAlign:"center",fontSize:11,color:"#64748B",marginTop:12}}>Free to start · Progress saved automatically</p>
    </div>
  );
}
...
function SportSelect({onNext}:{onNext:(s:typeof SPORTS[0])=>void}){
  return (
    <div style={{minHeight:"100%",display:"flex",flexDirection:"column",background:"#EBF5FD"}}>
      <div style={{padding:"20px 20px 0",position:"sticky",top:0,background:"#EBF5FD",zIndex:10}}>
        <Logo size={24}/><StepBar total={5} current={1}/>
        <h2 style={{fontWeight:900,fontSize:22,color:"#0F172A",marginBottom:4}}>What is your sport?</h2>
        <p style={{fontSize:13,color:"#64748B",marginBottom:16}}>You will join a squad of athletes from your sport.</p>
      </div>
      <div style={{flex:1,overflowY:"auto",padding:"0 20px 32px"}}>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
          {SPORTS.map(s=>(
            <button key={s.id} onClick={()=>onNext(s)} style={{background:"white",border:"1.5px solid #E2E8F0",borderRadius:16,padding:0,cursor:"pointer",textAlign:"left",overflow:"hidden",boxShadow:"0 2px 6px rgba(15,23,42,0.06)"}}>
              ...
              <div style={{padding:"8px 10px 10px"}}>
                ...
                <div style={{fontSize:10,color:"#64748B",marginTop:1}}>{s.athlete}</div>
                <div style={{fontSize:9,color:"#10B981",fontWeight:700,marginTop:2}}>Active {s.liveUsers.toLocaleString()}</div>
              </div>
            </button>
          ))}
        </div>
  ...
  return (
    <div style={{minHeight:"100%",display:"flex",flexDirection:"column",background:"#EBF5FD"}}>
      <div style={{padding:"20px 20px 0",position:"sticky",top:0,background:"#EBF5FD",zIndex:10}}>
        ...
        <h2 style={{fontWeight:900,fontSize:22,color:"#0F172A",marginBottom:4}}>What is your injury?</h2>
        <p style={{fontSize:13,color:"#64748B",marginBottom:16}}>Select closest match — we fine-tune by severity next.</p>
      </div>
      <div style={{flex:1,overflowY:"auto",padding:"0 20px 32px"}}>
        {INJURIES.map(inj=>(
          <button key={inj.id} onClick={()=>onNext(inj)} style={{width:"100%",background:"white",border:"1.5px solid #E2E8F0",borderRadius:16,padding:"14px 16px",cursor:"pointer",textAlign:"left",display:"flex",alignItems:"center",gap:14,marginBottom:10,boxShadow:"0 2px 6px rgba(15,23,42,0.05)"}}>
            <span style={{fontSize:26}}>{inj.icon}</span>
            <div style={{flex:1}}>
              <div style={{fontWeight:700,fontSize:14,color:"#0F172A"}}>{inj.label}</div>
              <div style={{fontSize:11,color:"#64748B",marginTop:2}}>{inj.weeks}-week protocol</div>
            </div>
  ...
  return (
    <div style={{minHeight:"100%",display:"flex",flexDirection:"column",background:"#EBF5FD"}}>
      <div style={{padding:"20px 20px 0",position:"sticky",top:0,background:"#EBF5FD",zIndex:10}}>
        ...
        <h2 style={{fontWeight:900,fontSize:22,color:"#0F172A",marginBottom:4}}>How severe is it?</h2>
        <p style={{fontSize:13,color:"#64748B",marginBottom:16}}>This determines your protocol intensity.</p>
      </div>
      <div style={{flex:1,overflowY:"auto",padding:"0 20px 32px"}}>
        {SEVERITIES.map(sv=>(
          <button key={sv.id} onClick={()=>onNext(sv)} style={{width:"100%",background:"white",border:"2px solid #E2E8F0",borderRadius:18,padding:"18px 16px",cursor:"pointer",textAlign:"left",marginBottom:12,boxShadow:"0 2px 8px rgba(15,23,42,0.06)"}}>
            <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:6}}>
              <span style={{fontSize:24}}>{sv.icon}</span>
              <span style={{fontWeight:800,fontSize:16,color:"#0F172A"}}>{sv.label}</span>
              <TagPill color={sv.color} bg={sv.bg}>{sv.label}</TagPill>
            </div>
            <p style={{fontSize:13,color:"#64748B",margin:0,paddingLeft:36}}>{sv.desc}</p>
          </button>
        ))}
      </div>
    </div>
  ...
  return (
    <div style={{minHeight:"100%",display:"flex",flexDirection:"column",background:"#EBF5FD"}}>
      <div style={{padding:"20px 20px 0",position:"sticky",top:0,background:"#EBF5FD",zIndex:10}}>
        ...
        <h2 style={{fontWeight:900,fontSize:22,color:"#0F172A",marginBottom:4}}>What is your number 1 goal?</h2>
        <p style={{fontSize:13,color:"#64748B",marginBottom:16}}>Shapes your daily task emphasis and macros.</p>
      </div>
      <div style={{flex:1,overflowY:"auto",padding:"0 20px 32px"}}>
        {GOALS_LIST.map(g=>(
          <button key={g.id} onClick={()=>onNext(g)} style={{width:"100%",background:"white",border:"1.5px solid #E2E8F0",borderRadius:18,padding:"18px 16px",cursor:"pointer",textAlign:"left",display:"flex",alignItems:"center",gap:14,marginBottom:12,boxShadow:"0 2px 8px rgba(15,23,42,0.06)"}}>
            <span style={{fontSize:28}}>{g.icon}</span>
            <div style={{flex:1}}>
              <div style={{fontWeight:800,fontSize:15,color:"#0F172A"}}>{g.label}</div>
...
function PlanSelect({onNext}:{onNext:(plan:"free"|"pro"|"elite")=>void}){
  ...
  const freeMiss=["Personalised nutrition and macros","Supplement schedule","AI Avatar trainer","Video library","Advanced analytics","1-on-1 PT consults"];
  const proHave=["Everything in Free","Personalised macros and nutrition","Supplement timing schedule","Video exercise library","Progress analytics","Priority email support"];
  const proMiss=["AI Avatar personal trainer","1-on-1 PT video consults","Custom meal plans","Custom supplement stack"];
  const eliteHave=["Everything in Pro","Your own AI Avatar trainer","Animated trainer reacts to your progress","Daily coach pep talks and compliments","1-on-1 PT video consults","Custom meal and supplement plans","24/7 priority support"];
  return (
    <div style={{minHeight:"100%",display:"flex",flexDirection:"column",background:"#EBF5FD"}}>
      <div style={{padding:"20px 20px 0",position:"sticky",top:0,background:"#EBF5FD",zIndex:10}}>
        <Logo size={24}/><StepBar total={5} current={5}/>
        <h2 style={{fontWeight:900,fontSize:22,color:"#0F172A",marginBottom:4}}>Choose your plan</h2>
        <p style={{fontSize:13,color:"#64748B",marginBottom:16}}>Start free for 24 hours. Upgrade anytime.</p>
      </div>
      <div style={{flex:1,overflowY:"auto",padding:"0 20px 32px"}}>
        <div style={{background:"white",borderRadius:18,padding:"18px 16px",border:"2px solid #E2E8F0",marginBottom:12}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
            <div style={{display:"flex",alignItems:"center",gap:8}}><span style={{fontSize:22}}>🌱</span><span style={{fontWeight:800,fontSize:16,color:"#0F172A"}}>Free</span></div>
            <div style={{textAlign:"right"}}><span style={{fontWeight:900,fontSize:18,color:"#0F172A"}}>$0</span><div style={{fontSize:9,color:"#64748B"}}>24hr trial</div></div>
          </div>
          {freeHave.map((f,j)=><div key={j} style={{display:"flex",gap:8,marginBottom:5,alignItems:"center"}}><Check size={13} color="#10B981" strokeWidth={3}/><span style={{fontSize:12,color:"#334155"}}>{f}</span></div>)}
          {freeMiss.map((f,j)=><div key={j} style={{display:"flex",gap:8,marginBottom:5,alignItems:"center"}}><X size={13} color="#EF4444" strokeWidth={3}/><span style={{fontSize:12,color:"#94A3B8",textDecoration:"line-through"}}>{f}</span></div>)}
          <button onClick={()=>onNext("free")} style={{width:"100%",marginTop:14,padding:"12px",borderRadius:12,background:"transparent",color:"#334155",fontWeight:700,fontSize:13,border:"1.5px solid #E2E8F0",cursor:"pointer"}}>Start Free Trial</button>
        </div>

        <div style={{background:"white",borderRadius:18,padding:"18px 16px",border:"2px solid #10B981",marginBottom:12,boxShadow:"0 4px 16px #10B98120",position:"relative"}}>
          <div style={{position:"absolute",top:-10,right:16,background:"#10B981",color:"white",fontSize:10,fontWeight:800,padding:"3px 10px",borderRadius:10}}>BEST VALUE</div>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
            <div style={{display:"flex",alignItems:"center",gap:8}}><span style={{fontSize:22}}>⚡</span><span style={{fontWeight:800,fontSize:16,color:"#0F172A"}}>Pro</span></div>
            <div style={{textAlign:"right"}}><span style={{fontWeight:900,fontSize:18,color:"#10B981"}}>$9.99/mo</span><div style={{fontSize:9,color:"#64748B"}}>billed monthly</div></div>
          </div>
          {proHave.map((f,j)=><div key={j} style={{display:"flex",gap:8,marginBottom:5,alignItems:"center"}}><Check size={13} color="#10B981" strokeWidth={3}/><span style={{fontSize:12,color:"#334155"}}>{f}</span></div>)}
          {proMiss.map((f,j)=><div key={j} style={{display:"flex",gap:8,marginBottom:5,alignItems:"center"}}><X size={13} color="#EF4444" strokeWidth={3}/><span style={{fontSize:12,color:"#94A3B8",textDecoration:"line-through"}}>{f}</span></div>)}
          <button onClick={()=>{window.open(PLAN_PRO_URL,"_blank");onNext("pro");}} style={{width:"100%",marginTop:14,padding:"12px",borderRadius:12,background:"#10B981",color:"white",fontWeight:700,fontSize:13,border:"none",cursor:"pointer"}}>Get Pro</button>
          <p style={{fontSize:10,color:"#64748B",textAlign:"center",marginTop:6}}>Secure checkout via Stripe. Cancel anytime.</p>
        </div>

        <div style={{background:"linear-gradient(135deg,#1C1C2E,#2D2B5E)",borderRadius:18,padding:"18px 16px",border:"2px solid #6366F1",marginBottom:16,boxShadow:"0 8px 24px #6366F130",position:"relative"}}>
          <div style={{position:"absolute",top:-10,right:16,background:"#6366F1",color:"white",fontSize:10,fontWeight:800,padding:"3px 10px",borderRadius:10}}>MOST POPULAR</div>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
            ...
            <div style={{textAlign:"right"}}><span style={{fontWeight:900,fontSize:18,color:"#E8FF47"}}>$28.99/mo</span><div style={{fontSize:9,color:"rgba(255,255,255,0.4)"}}>billed monthly</div></div>
          </div>
          {eliteHave.map((f,j)=><div key={j} style={{display:"flex",gap:8,marginBottom:5,alignItems:"center"}}><Check size={13} color="#E8FF47" strokeWidth={3}/><span style={{fontSize:12,color:"rgba(255,255,255,0.85)"}}>{f}</span></div>)}
          <button onClick={()=>{window.open(PLAN_ELITE_URL,"_blank");onNext("elite");}} style={{width:"100%",marginTop:14,padding:"12px",borderRadius:12,background:"#E8FF47",color:"#0F172A",fontWeight:800,fontSize:13,border:"none",cursor:"pointer"}}>Get Elite + Avatar</button>
...
function NavBtn({icon,label,active,onClick}:{icon:ReactNode,label:string,active:boolean,onClick:()=>void}){
  return (
    <button onClick={onClick} style={{display:"flex",flexDirection:"column",alignItems:"center",gap:3,padding:"4px 10px",background:"none",border:"none",cursor:"pointer"}}>
      <div style={{color:active?"#6366F1":"#94A3B8"}}>{icon}</div>
      <span style={{fontSize:10,fontWeight:700,color:active?"#6366F1":"#94A3B8"}}>{label}</span>
    </button>
  );
}
...
function TaskCard({task,checked,onToggle}:{task:Task,checked:boolean,onToggle:()=>void}){
  return (
    <div onClick={onToggle} style={{display:"flex",gap:12,alignItems:"flex-start",background:"white",borderRadius:14,padding:"12px 14px",border:`1px solid ${checked?"#10B981":"#E2E8F0"}`,boxShadow:"0 1px 4px rgba(15,23,42,0.05)",cursor:"pointer",opacity:checked?0.7:1,transition:"all 0.2s"}}>
      ...
      <div style={{flex:1,minWidth:0}}>
        <div style={{fontSize:10,fontWeight:700,color:"#64748B",marginBottom:2}}>{task.time}</div>
        <div style={{fontSize:12,color:checked?"#64748B":"#334155",lineHeight:1.45,textDecoration:checked?"line-through":"none",fontWeight:500}}>{task.task}</div>
      </div>
      <div style={{width:22,height:22,borderRadius:11,background:checked?"#10B981":"#E2E8F0",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,marginTop:2,transition:"background 0.2s"}}>
...
function AppDashboard({saved,onReset,onUpgrade}:{saved:SavedState,onReset:()=>void,onUpgrade:(p:"pro"|"elite")=>void}){
  ...
  const avatarMood: "happy"|"sad"|"excited"|"neutral"=allDone?"excited":doneCount>=tasks.length*0.6?"happy":!saved.streakAlive?"sad":"neutral";
  const avatarQuote=allDone?AVATAR_QUOTES.goal[dayNum%AVATAR_QUOTES.goal.length]:!saved.streakAlive?AVATAR_QUOTES.miss[dayNum%AVATAR_QUOTES.miss.length]:doneCount===0?AVATAR_QUOTES.morning[dayNum%AVATAR_QUOTES.morning.length]:AVATAR_QUOTES.streak[dayNum%AVATAR_QUOTES.streak.length];
  ...
  if(trialExpired){
    return (
      <div style={{height:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24,background:"#EBF5FD",textAlign:"center"}}>
        <div style={{fontSize:48,marginBottom:16}}>⏰</div>
        <h2 style={{fontWeight:900,fontSize:24,color:"#0F172A",marginBottom:8}}>Free Trial Ended</h2>
        <p style={{fontSize:14,color:"#64748B",marginBottom:24,lineHeight:1.6}}>Your 24-hour trial is up! Upgrade to keep your streak alive and continue your recovery journey.</p>
        <button onClick={()=>{window.open(PLAN_ELITE_URL,"_blank");onUpgrade("elite");}} style={{width:"100%",padding:"16px",borderRadius:14,background:"#E8FF47",color:"#0F172A",fontWeight:900,fontSize:16,border:"none",cursor:"pointer",marginBottom:12}}>
          Get Elite — $28.99/mo (includes AI Avatar trainer)
        </button>
        <button onClick={()=>{window.open(PLAN_PRO_URL,"_blank");onUpgrade("pro");}} style={{width:"100%",padding:"14px",borderRadius:14,background:"#10B981",color:"white",fontWeight:800,fontSize:14,border:"none",cursor:"pointer",marginBottom:12}}>
          Get Pro — $9.99/mo
        </button>
        <p style={{fontSize:11,color:"#64748B"}}>Secure checkout via Stripe. Cancel anytime.</p>
      </div>
    );
  }
    ...
    return (
      <div style={{height:"100%",display:"flex",flexDirection:"column"}}>
        <div style={{flex:1,overflow:"hidden",display:"flex",flexDirection:"column",minHeight:0}}>
          <AvatarBuilder onSave={handleSaveAvatar}/>
        </div>
      </div>
    );
  }
  ...
  const renderTab=()=>{
    switch(tab){
      case "home": return (
        <div style={{flex:1,overflowY:"auto",background:"#EBF5FD",padding:"20px 18px 100px"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20}}>
            <Logo size={26}/>
            <div style={{display:"flex",alignItems:"center",gap:8}}>
              <div style={{background:"white",border:"1px solid #E2E8F0",borderRadius:20,padding:"6px 12px",display:"flex",alignItems:"center",gap:5,boxShadow:"0 2px 6px rgba(15,23,42,0.06)"}}>
                <StreakFire streak={saved.streak} alive={saved.streakAlive}/>
              </div>
              <div style={{width:36,height:36,borderRadius:18,background:"#EDE9FE",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18}}>{sport?.icon||"🏆"}</div>
            </div>
          </div>

          {saved.plan==="elite"&&avatarState&&(
            <Card style={{marginBottom:16,background:"linear-gradient(135deg,#EDE9FE,#F0FDF4)",border:"1px solid #6366F120"}}>
              <div style={{display:"flex",gap:12,alignItems:"center"}}>
                <AvatarDisplay avatar={avatarState} size={70} mood={avatarMood}/>
                <div style={{flex:1}}>
                  <div style={{fontWeight:800,fontSize:11,color:"#6366F1",marginBottom:4}}>YOUR TRAINER SAYS</div>
                  <p style={{fontSize:13,color:"#0F172A",lineHeight:1.5,fontStyle:"italic",margin:0}}>{avatarQuote}</p>
                </div>
              </div>
            </Card>
          )}
          ...
          {saved.plan==="elite"&&!avatarState&&(
            <Card style={{marginBottom:16,background:"linear-gradient(135deg,#1C1C2E,#2D2B5E)",border:"none"}}>
              <div style={{display:"flex",gap:12,alignItems:"center"}}>
                ...
                <div style={{flex:1}}>
                  <div style={{fontWeight:800,fontSize:12,color:"#E8FF47",marginBottom:4}}>BUILD YOUR AVATAR TRAINER</div>
                  <p style={{fontSize:12,color:"rgba(255,255,255,0.7)",margin:0,marginBottom:8}}>You are on Elite. Create your personal AI coach!</p>
                  <button onClick={()=>setShowAvatarBuilder(true)} style={{padding:"8px 16px",borderRadius:10,background:"#E8FF47",color:"#0F172A",fontWeight:800,fontSize:12,border:"none",cursor:"pointer"}}>Build Now</button>
                </div>
              </div>
            </Card>
          )}
          ...
          <Card style={{background:"linear-gradient(135deg,#1C1C2E,#2D2B5E)",border:"none",marginBottom:16,padding:"18px 16px"}}>
            ...
            <ProgressBar pct={pct} color="#E8FF47"/>
            <div style={{display:"flex",justifyContent:"space-between",marginTop:6}}>
              <span style={{fontSize:10,color:"rgba(255,255,255,0.4)"}}>Day 1</span>
              <span style={{fontSize:10,color:"#E8FF47",fontWeight:700}}>{pct}% complete</span>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:10,marginBottom:16}}>
            <Card style={{textAlign:"center",padding:"12px 8px"}}>
              ...
              <div style={{fontSize:10,color:"#64748B",fontWeight:600}}>Streak</div>
            </Card>
            <Card style={{textAlign:"center",padding:"12px 8px"}}>
              <div style={{fontWeight:900,fontSize:16,color:"#0F172A",marginBottom:4}}>{doneCount}/{tasks.length}</div>
              <div style={{fontSize:10,color:"#64748B",fontWeight:600}}>Today</div>
            </Card>
            <Card style={{textAlign:"center",padding:"12px 8px"}}>
              <div style={{fontWeight:900,fontSize:14,color:"#0F172A",marginBottom:4}}>Phase {phase}</div>
              <div style={{fontSize:10,color:"#64748B",fontWeight:600}}>Stage</div>
            </Card>
          </div>

          {!saved.streakAlive&&(
            <Card style={{background:"#FEF2F2",border:"1.5px solid #EF444430",marginBottom:16}}>
              <div style={{display:"flex",gap:10,alignItems:"center"}}>
                <span style={{fontSize:28}}>💧</span>
                <div>
                  <div style={{fontWeight:800,fontSize:13,color:"#EF4444"}}>Streak Reset</div>
                  <div style={{fontSize:12,color:"#334155"}}>Complete today's tasks to relight your fire</div>
                </div>
              </div>
            </Card>
          )}

          <Card style={{background:"linear-gradient(135deg,#EDE9FE,#F0FDF4)",border:"1px solid #6366F120",marginBottom:16}}>
            <TagPill color="#6D28D9" bg="#6366F122">{dailyContent.type==="verse"?"📿 Bible Verse":"💡 Motivation"}</TagPill>
            <p style={{fontSize:13,fontStyle:"italic",color:"#0F172A",lineHeight:1.65,marginTop:8,fontFamily:"Georgia,serif"}}>{dailyContent.quote}</p>
            <p style={{fontSize:10,fontWeight:700,color:"#6D28D9",marginTop:6}}>— {dailyContent.text}</p>
          </Card>

          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
            <h2 style={{fontWeight:900,fontSize:17,color:"#0F172A"}}>Today's Focus</h2>
            <button onClick={()=>setTab("today")} style={{fontSize:12,fontWeight:700,color:"#6366F1",background:"none",border:"none",cursor:"pointer"}}>View all</button>
          </div>
            ...
            <Card style={{background:`linear-gradient(135deg,${sport.color}15,${sport.color}05)`,border:`1px solid ${sport.color}30`,marginBottom:16}}>
              <div style={{display:"flex",gap:10,alignItems:"flex-start"}}>
                ...
                <div>
                  ...
                  <p style={{fontSize:12,fontStyle:"italic",color:"#334155",lineHeight:1.5,margin:0}}>{sport.quotes[dayNum%sport.quotes.length]}</p>
                </div>
              </div>
            </Card>
          )}
          ...
          {saved.plan!=="elite"&&(
            <Card style={{background:"linear-gradient(135deg,#1C1C2E,#2D2B5E)",border:"none",marginBottom:12,padding:"16px"}}>
              ...
              <div style={{display:"flex",gap:8}}>
                {saved.plan==="free"&&<button onClick={()=>{window.open(PLAN_PRO_URL,"_blank");onUpgrade("pro");}} style={{flex:1,padding:"10px",borderRadius:10,background:"#10B981",color:"white",fontWeight:700,fontSize:11,border:"none",cursor:"pointer"}}>Pro $9.99/mo</button>}
                <button onClick={()=>{window.open(PLAN_ELITE_URL,"_blank");onUpgrade("elite");}} style={{flex:1,padding:"10px",borderRadius:10,background:"#E8FF47",color:"#0F172A",fontWeight:800,fontSize:11,border:"none",cursor:"pointer"}}>Elite $28.99/mo</button>
              </div>
              <p style={{fontSize:10,color:"rgba(255,255,255,0.3)",textAlign:"center",marginTop:8}}>Secure checkout via Stripe. Cancel anytime.</p>
            </Card>
          )}

          <button onClick={()=>{if(window.confirm("Reset recovery plan? All progress will be cleared."))onReset();}} style={{width:"100%",padding:"10px",borderRadius:12,background:"transparent",color:"#64748B",fontSize:12,fontWeight:600,border:"1px solid #E2E8F0",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:6}}>
      ...
      case "today": return (
        <div style={{flex:1,overflowY:"auto",background:"#EBF5FD",padding:"20px 0 100px"}}>
          <div style={{padding:"0 18px",marginBottom:14}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
              <div>
                <h1 style={{fontWeight:900,fontSize:24,color:"#0F172A",lineHeight:1}}>Day {dayNum}</h1>
                <div style={{display:"flex",alignItems:"center",gap:8,marginTop:5}}>
                  <TagPill color="#6D28D9" bg="#EDE9FE">Phase {phase}</TagPill>
                  <span style={{fontSize:12,color:"#64748B",fontWeight:600}}>{injury?.label}</span>
                </div>
              </div>
              <div style={{background:"white",border:"1px solid #E2E8F0",borderRadius:20,padding:"7px 13px",boxShadow:"0 2px 6px rgba(15,23,42,0.06)"}}>
                <StreakFire streak={saved.streak} alive={saved.streakAlive}/>
              </div>
            </div>
            <Card style={{background:"linear-gradient(135deg,#EDE9FE,#F0FDF4)",border:"1px solid #6366F120",marginBottom:14}}>
              <TagPill color="#6D28D9" bg="#6366F122">{dailyContent.type==="verse"?"📿 Bible Verse":"💡 Motivation"}</TagPill>
              <p style={{fontSize:13,fontStyle:"italic",color:"#0F172A",lineHeight:1.65,marginTop:8,fontFamily:"Georgia,serif"}}>{dailyContent.quote}</p>
              <p style={{fontSize:10,fontWeight:700,color:"#6D28D9",marginTop:6}}>— {dailyContent.text}</p>
            </Card>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
              <h2 style={{fontWeight:900,fontSize:18,color:"#0F172A"}}>Today's Protocol</h2>
              <span style={{fontSize:10,fontWeight:700,color:allDone?"#10B981":"#64748B",background:"white",border:`1px solid ${allDone?"#10B981":"#E2E8F0"}`,borderRadius:8,padding:"4px 8px"}}>{doneCount}/{tasks.length} done</span>
            </div>
          </div>
          <div style={{padding:"0 18px"}}>
            <div style={{fontSize:13,fontWeight:800,color:"#334155",marginBottom:8}}>Morning</div>
            ...
            <div style={{fontSize:13,fontWeight:800,color:"#334155",marginBottom:8}}>Afternoon</div>
            ...
            <div style={{fontSize:13,fontWeight:800,color:"#334155",marginBottom:8}}>Evening</div>
            ...
            {allDone&&(
              <Card style={{background:"linear-gradient(135deg,#D1FAE5,#F0FDF4)",border:"1.5px solid #10B981",marginTop:20,textAlign:"center",padding:"20px 16px"}}>
                <div style={{fontSize:40,marginBottom:8}}>🎉</div>
                <div style={{fontWeight:900,fontSize:18,color:"#10B981",marginBottom:4}}>Day Complete!</div>
                <div style={{fontSize:13,color:"#334155"}}>Every task done. Your body is healing. See you tomorrow.</div>
                {saved.plan==="elite"&&avatarState&&<div style={{marginTop:12,display:"flex",justifyContent:"center"}}><AvatarDisplay avatar={avatarState} size={70} mood="excited"/></div>}
              </Card>
            )}
          </div>
        </div>
      ...
      case "protocol": return (
        <div style={{flex:1,overflowY:"auto",background:"#EBF5FD",padding:"20px 18px 100px"}}>
          <h1 style={{fontWeight:900,fontSize:22,color:"#0F172A",marginBottom:4}}>{injury?.label||"Recovery Protocol"}</h1>
          <p style={{fontSize:13,color:"#64748B",marginBottom:20}}>{injury?.weeks||12}-week protocol · Week {weekNum} · Phase {phase}</p>

          {[
            {phase:"Phase 1",title:"Protection and Healing",desc:injury?.phase1,color:"#6366F1",bg:"#EDE9FE",active:phase===1},
            {phase:"Phase 2",title:"Strength and Mobility",desc:injury?.phase2,color:"#10B981",bg:"#D1FAE5",active:phase===2},
            {phase:"Phase 3",title:"Return to Sport",desc:injury?.phase3,color:"#F97316",bg:"#FFF0E6",active:phase===3},
          ].map((p,i)=>(
            <div key={i} style={{display:"flex",gap:14,marginBottom:20,opacity:p.active?1:0.55}}>
              <div style={{display:"flex",flexDirection:"column",alignItems:"center"}}>
                <div style={{width:36,height:36,borderRadius:18,background:p.active?p.color:"#E2E8F0",display:"flex",alignItems:"center",justifyContent:"center",color:"white",fontWeight:800,fontSize:13,flexShrink:0}}>{i+1}</div>
                {i<2&&<div style={{width:2,flex:1,background:"#E2E8F0",marginTop:4}}/>}
              </div>
              <div style={{flex:1,paddingBottom:8}}>
                <div style={{display:"flex",gap:8,marginBottom:6,flexWrap:"wrap"}}>
                  <TagPill color={p.color} bg={p.bg}>{p.phase}</TagPill>
                  {p.active&&<TagPill color="#10B981" bg="#D1FAE5">You are here</TagPill>}
                </div>
                <h3 style={{fontWeight:800,fontSize:15,color:"#0F172A",margin:"0 0 8px"}}>{p.title}</h3>
                <Card style={{fontSize:13,color:"#334155",lineHeight:1.6}}>{p.desc}</Card>
              </div>
            </div>
          ))}

          <h2 style={{fontWeight:900,fontSize:17,color:"#0F172A",marginBottom:4,marginTop:8}}>Supplement Schedule</h2>
          <p style={{fontSize:12,color:"#64748B",marginBottom:12}}>Tap each to mark as taken. Timed throughout the day for maximum absorption.</p>
          {SUPPLEMENTS.map((s,i)=>(
            <div key={i} onClick={()=>toggleSupp(i)} style={{display:"flex",gap:12,alignItems:"flex-start",background:"white",borderRadius:14,padding:"12px 14px",border:`1.5px solid ${suppChecked[i]?"#10B981":"#E2E8F0"}`,marginBottom:10,cursor:"pointer",opacity:suppChecked[i]?0.7:1,transition:"all 0.2s"}}>
              ...
              <div style={{flex:1}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:4}}>
                  <div style={{fontWeight:800,fontSize:13,color:"#0F172A"}}>{s.label} — <span style={{color:s.color}}>{s.dose}</span></div>
                  <TagPill color="#64748B" bg="#F1F5F9">{s.time}</TagPill>
                </div>
                <div style={{fontSize:10,fontWeight:700,color:"#10B981",marginTop:2}}>Take with {s.with}</div>
                <div style={{fontSize:11,color:"#334155",marginTop:4,lineHeight:1.4}}>{s.note}</div>
              </div>
              <div style={{width:22,height:22,borderRadius:11,background:suppChecked[i]?"#10B981":"#E2E8F0",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,marginTop:2}}>
                {suppChecked[i]&&<Check size={13} color="white" strokeWidth={3}/>}
              </div>
            </div>
          ))}
          <div style={{fontSize:11,color:"#64748B",textAlign:"center",marginBottom:20}}>{suppChecked.filter(Boolean).length}/{SUPPLEMENTS.length} supplements taken today</div>

          <h2 style={{fontWeight:900,fontSize:17,color:"#0F172A",marginBottom:4}}>Nutrition and Macros</h2>
          <p style={{fontSize:12,color:"#64748B",marginBottom:12}}>Science-backed anti-inflammatory eating for faster recovery.</p>

          {saved.plan==="free"?(
            <Card style={{marginBottom:16,border:"1.5px solid #6366F140",background:"#EDE9FE"}}>
              <div style={{display:"flex",gap:10,alignItems:"center"}}>
                <span style={{fontSize:28}}>📊</span>
                <div style={{flex:1}}>
                  <div style={{fontWeight:800,fontSize:13,color:"#6366F1"}}>Personalised Macros — Pro Feature</div>
                  <div style={{fontSize:12,color:"#334155",marginTop:2}}>Upgrade to Pro to get your exact daily protein, carbs, and fat targets based on your body and goal.</div>
                </div>
              </div>
              <button onClick={()=>{window.open(PLAN_PRO_URL,"_blank");onUpgrade("pro");}} style={{width:"100%",marginTop:10,padding:"10px",borderRadius:10,background:"#6366F1",color:"white",fontWeight:700,fontSize:12,border:"none",cursor:"pointer"}}>Upgrade to Pro</button>
            </Card>
            ...
            <Card style={{marginBottom:16,background:"linear-gradient(135deg,#D1FAE5,#F0FDF4)",border:"1.5px solid #10B98140"}}>
              <div style={{fontWeight:800,fontSize:13,color:"#10B981",marginBottom:12}}>Your Daily Targets</div>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:12}}>
                {[{label:"Calories",val:`${macros.calories}`,unit:"kcal",color:"#F97316"},{label:"Protein",val:`${macros.protein}g`,unit:"priority",color:"#6366F1"},{label:"Carbs",val:`${macros.carbs}g`,unit:"energy",color:"#F59E0B"},{label:"Fat",val:`${macros.fat}g`,unit:"joints",color:"#10B981"}].map((m,i)=>(
                  <div key={i} style={{background:"white",borderRadius:12,padding:"10px",textAlign:"center",border:"1px solid #E2E8F0"}}>
                    <div style={{fontWeight:900,fontSize:18,color:m.color}}>{m.val}</div>
                    <div style={{fontWeight:700,fontSize:11,color:"#0F172A"}}>{m.label}</div>
                    <div style={{fontSize:9,color:"#64748B"}}>{m.unit}</div>
                  </div>
                ))}
              </div>
              <div style={{fontSize:11,color:"#334155",lineHeight:1.5}}>Based on Mifflin-St Jeor formula. Protein set at 2g/kg bodyweight — elevated for injury recovery per sports nutrition research.</div>
              <button onClick={()=>setShowBodyForm(true)} style={{marginTop:8,fontSize:11,color:"#64748B",background:"none",border:"none",cursor:"pointer",textDecoration:"underline"}}>Update my measurements</button>
            </Card>
          ) : null}

          {DIET_GUIDE.map((d,i)=>(
            <Card key={i} style={{marginBottom:10}}>
              <div style={{fontWeight:800,fontSize:12,color:"#6366F1",marginBottom:6}}>{d.category}</div>
              <div style={{fontSize:12,color:"#0F172A",lineHeight:1.5,marginBottom:4}}><span style={{fontWeight:700}}>Eat: </span>{d.foods}</div>
              <div style={{fontSize:11,color:"#EF4444",lineHeight:1.4}}><span style={{fontWeight:700}}>Avoid: </span>{d.avoid}</div>
            </Card>
          ))}
        </div>
      );
      ...
      case "squad": return (
        <div style={{flex:1,overflowY:"auto",background:"#EBF5FD",padding:"20px 18px 100px"}}>
          <h1 style={{fontWeight:900,fontSize:22,color:"#0F172A",marginBottom:4}}>{sport?.icon} {sport?.label} Squad</h1>
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:16}}>
            <div style={{width:8,height:8,borderRadius:4,background:"#10B981"}}/>
            <span style={{fontSize:13,fontWeight:700,color:"#10B981"}}>{sport?.liveUsers.toLocaleString()} athletes active right now</span>
          </div>
          ...
          <Card style={{marginBottom:16}}>
            <textarea value={newPost} onChange={e=>setNewPost(e.target.value)} placeholder={`Share your recovery update with the ${sport?.label} squad...`}
              style={{width:"100%",minHeight:70,border:"none",outline:"none",fontSize:13,color:"#0F172A",resize:"none",fontFamily:"inherit",background:"transparent",boxSizing:"border-box"}}/>
            <div style={{display:"flex",justifyContent:"flex-end"}}>
              <button onClick={handleNewPost} style={{display:"flex",alignItems:"center",gap:6,padding:"8px 16px",borderRadius:10,background:"#6366F1",color:"white",fontWeight:700,fontSize:12,border:"none",cursor:"pointer"}}>
                <Send size={13}/> Post
              </button>
            </div>
          </Card>
          ...
          {posts.map(p=>(
            <Card key={p.id} style={{marginBottom:12}}>
              <div style={{display:"flex",gap:10,marginBottom:8}}>
                <div style={{width:36,height:36,borderRadius:18,background:"#EDE9FE",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,flexShrink:0}}>{sport?.icon}</div>
                <div>
                  <div style={{fontWeight:700,fontSize:13,color:"#0F172A"}}>{p.author}</div>
                  <div style={{fontSize:10,color:"#64748B"}}>{sport?.label} Recovery</div>
                </div>
              </div>
              <p style={{fontSize:13,color:"#334155",lineHeight:1.5,margin:"0 0 10px"}}>{p.msg}</p>
              {p.replies.length>0&&(
                <div style={{borderLeft:"2px solid #E2E8F0",paddingLeft:12,marginBottom:10}}>
                  {p.replies.map((r,ri)=>(
                    <div key={ri} style={{marginBottom:6}}>
                      <span style={{fontWeight:700,fontSize:11,color:"#0F172A"}}>{r.author}: </span>
                      <span style={{fontSize:11,color:"#334155"}}>{r.msg}</span>
                    </div>
                  ))}
                </div>
              )}
              {replyingTo===p.id&&(
                <div style={{display:"flex",gap:8,marginBottom:10}}>
                  <input value={replyText} onChange={e=>setReplyText(e.target.value)} placeholder="Write a reply..."
                    style={{flex:1,padding:"8px 12px",borderRadius:10,border:"1.5px solid #6366F1",fontSize:12,fontFamily:"inherit",outline:"none"}}
                    onKeyDown={e=>e.key==="Enter"&&handleReply(p.id)}/>
                  <button onClick={()=>handleReply(p.id)} style={{padding:"8px 12px",borderRadius:10,background:"#6366F1",color:"white",fontWeight:700,fontSize:12,border:"none",cursor:"pointer"}}>
                    <Send size={13}/>
                  </button>
                </div>
              )}
              <div style={{display:"flex",gap:12}}>
                <button onClick={()=>handleLike(p.id)} style={{display:"flex",alignItems:"center",gap:4,fontSize:12,fontWeight:700,color:p.likedByMe?"#EF4444":"#64748B",background:"none",border:"none",cursor:"pointer"}}>
                  <Heart size={14} fill={p.likedByMe?"#EF4444":"none"} color={p.likedByMe?"#EF4444":"#64748B"}/> {p.likes}
                </button>
                <button onClick={()=>setReplyingTo(replyingTo===p.id?null:p.id)} style={{display:"flex",alignItems:"center",gap:4,fontSize:12,fontWeight:700,color:"#64748B",background:"none",border:"none",cursor:"pointer"}}>
      ...
      case "rewards": return (
        <div style={{flex:1,overflowY:"auto",background:"#EBF5FD",padding:"20px 18px 100px"}}>
          <h1 style={{fontWeight:900,fontSize:22,color:"#0F172A",marginBottom:4}}>Milestones</h1>
          <p style={{fontSize:13,color:"#64748B",marginBottom:6}}>Stay consistent. Unlock badges as you progress.</p>
          <Card style={{background:"linear-gradient(135deg,#1C1C2E,#2D2B5E)",border:"none",marginBottom:16,padding:"14px 16px"}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:12}}>
              <StreakFire streak={saved.streak} alive={saved.streakAlive}/>
              <div style={{fontSize:11,color:"rgba(255,255,255,0.5)"}}>{saved.streakAlive?"days strong":"relight it today"}</div>
            </div>
            <ProgressBar pct={pct} color="#E8FF47"/>
          ...
          {MILESTONES.map((m,i)=>{
            ...
            return (
              <Card key={i} style={{marginBottom:12,opacity:(!unlocked&&!isNext)?0.4:1,border:unlocked?"1.5px solid #10B981":isNext?"1.5px solid #6366F140":"1.5px solid #E2E8F0"}}>
                <div style={{display:"flex",gap:12,alignItems:"flex-start"}}>
                  <div style={{width:46,height:46,borderRadius:23,background:unlocked?"#D1FAE5":isNext?"#EDE9FE":"#F1F5F9",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,flexShrink:0}}>{m.badge}</div>
                  <div style={{flex:1}}>
                    <div style={{display:"flex",justifyContent:"space-between",marginBottom:4}}>
                      <span style={{fontWeight:800,fontSize:14,color:unlocked?"#10B981":"#0F172A"}}>{m.title}</span>
                      <TagPill color={unlocked?"#10B981":isNext?"#6366F1":"#64748B"} bg={unlocked?"#D1FAE5":isNext?"#EDE9FE":"#F1F5F9"}>Day {m.day}</TagPill>
                    </div>
                    {unlocked&&<div style={{fontSize:10,fontWeight:800,color:"#10B981",marginBottom:4}}>UNLOCKED</div>}
                    {isNext&&<div style={{fontSize:10,fontWeight:800,color:"#6366F1",marginBottom:4}}>{m.day-dayNum} days away</div>}
                    <div style={{fontSize:12,color:"#334155",marginBottom:6}}>{m.reward}</div>
                    <div style={{fontSize:11,fontStyle:"italic",color:"#64748B",borderLeft:`2px solid ${unlocked?"#10B981":"#E2E8F0"}`,paddingLeft:8}}>{m.verse}</div>
                  </div>
                </div>
              </Card>
            );
        ...
        <div style={{flex:1,overflowY:"auto",background:"#EBF5FD",padding:"20px 18px 100px"}}>
          {saved.plan!=="elite"?(
            <div style={{textAlign:"center",padding:"40px 20px"}}>
              <Crown size={48} color="#E8FF47" style={{marginBottom:16}}/>
              <h2 style={{fontWeight:900,fontSize:22,color:"#0F172A",marginBottom:8}}>Elite Feature</h2>
              <p style={{fontSize:14,color:"#64748B",marginBottom:24,lineHeight:1.6}}>Your personal AI avatar trainer is exclusive to the Elite plan. It reacts to your progress, gives daily coaching, and celebrates your wins.</p>
              <button onClick={()=>{window.open(PLAN_ELITE_URL,"_blank");onUpgrade("elite");}} style={{width:"100%",padding:"16px",borderRadius:14,background:"#E8FF47",color:"#0F172A",fontWeight:900,fontSize:16,border:"none",cursor:"pointer"}}>
            ...
            <div style={{textAlign:"center",padding:"40px 20px"}}>
              <div style={{fontSize:48,marginBottom:16}}>🤖</div>
              <h2 style={{fontWeight:900,fontSize:22,color:"#0F172A",marginBottom:8}}>Build Your Trainer</h2>
              <p style={{fontSize:14,color:"#64748B",marginBottom:24}}>Create your personalised AI coach who will guide you daily.</p>
              <PrimaryBtn onClick={()=>setShowAvatarBuilder(true)}>Build My Avatar</PrimaryBtn>
            </div>
          ) : (
            <>
              <h1 style={{fontWeight:900,fontSize:22,color:"#0F172A",marginBottom:4}}>Your Trainer</h1>
              <p style={{fontSize:13,color:"#64748B",marginBottom:20}}>Your personalised AI recovery coach.</p>
              <div style={{display:"flex",justifyContent:"center",marginBottom:20}}>
                <div style={{background:"white",borderRadius:24,padding:24,boxShadow:"0 8px 24px rgba(15,23,42,0.12)",border:"2px solid #6366F130",display:"inline-flex",flexDirection:"column",alignItems:"center",gap:12}}>
                  <AvatarDisplay avatar={avatarState} size={140} mood={avatarMood}/>
                  <div style={{textAlign:"center"}}>
                    <div style={{fontWeight:900,fontSize:16,color:"#0F172A"}}>Your Coach</div>
                    <div style={{fontSize:11,color:"#64748B"}}>{avatarState.bodyType} build · {avatarState.hairStyle} hair</div>
                  </div>
                </div>
              </div>
              <Card style={{background:"linear-gradient(135deg,#EDE9FE,#F0FDF4)",border:"1px solid #6366F120",marginBottom:16}}>
                <div style={{fontWeight:800,fontSize:11,color:"#6366F1",marginBottom:8}}>TODAY'S COACHING</div>
                <p style={{fontSize:14,fontStyle:"italic",color:"#0F172A",lineHeight:1.65,fontFamily:"Georgia,serif",margin:0}}>{avatarQuote}</p>
              </Card>
              <Card style={{marginBottom:16}}>
                <div style={{fontWeight:800,fontSize:13,color:"#0F172A",marginBottom:10}}>Your trainer reacts to your progress</div>
                {([["excited","All tasks done","Maximum celebration mode"],["happy",">60% tasks done","Proud and encouraging"],["neutral","Making progress","Steady focused coaching"],["sad","Streak lost","Concerned but supportive"]] as [("excited"|"happy"|"neutral"|"sad"),string,string][]).map(([mood,label,desc],i)=>(
                  <div key={i} style={{display:"flex",alignItems:"center",gap:10,marginBottom:8}}>
                    <AvatarDisplay avatar={avatarState} size={40} mood={mood}/>
                    <div>
              ...
              <button onClick={()=>setShowAvatarBuilder(true)} style={{width:"100%",padding:"12px",borderRadius:12,background:"transparent",color:"#6366F1",fontWeight:700,fontSize:13,border:"1.5px solid #6366F1",cursor:"pointer"}}>
                Customise Avatar
              </button>
            </>
          )}
  ...
  return (
    <div style={{height:"100%",display:"flex",flexDirection:"column",background:"#EBF5FD"}}>
      ...
      <div style={{flexShrink:0,background:"white",boxShadow:"0 -1px 0 rgba(15,23,42,0.08),0 -4px 12px rgba(15,23,42,0.06)",paddingBottom:"env(safe-area-inset-bottom,12px)",paddingTop:10,paddingLeft:4,paddingRight:4,display:"flex",justifyContent:"space-around",alignItems:"flex-end",zIndex:50}}>
        ...
        <button onClick={()=>setTab("today")} style={{width:56,height:56,borderRadius:28,background:tab==="today"?"#E8FF47":"#1C1C2E",display:"flex",alignItems:"center",justifyContent:"center",border:"4px solid white",boxShadow:"0 4px 14px rgba(15,23,42,0.25)",cursor:"pointer",marginBottom:4,flexShrink:0}}>
          <Dumbbell size={22} color={tab==="today"?"#0F172A":"white"}/>
        </button>
